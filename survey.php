...
print				"</div>\n";
print				"<div class='form-check'>\n";
print					"<input class='form-check-input' type='radio' name='toppingRadios' id='topping1' value='A' checked>\n";
print					"<label class='form-check-label' for='topping1'>\n";
print						"Cheese\n";
print					"</label>\n";
print				"</div>\n";
print				"<div class='form-check'>\n";
print					"<input class='form-check-input' type='radio' name='toppingRadios' id='topping2' value='B'>\n";
print					"<label class='form-check-label' for='topping2'>\n";
print						"Pepperoni\n";
print					"</label>\n";
print				"</div>\n";
print				"<div class='form-check'>\n";
print					"<input class='form-check-input' type='radio' name='toppingRadios' id='topping3' value='C'>\n";
print					"<label class='form-check-label' for='topping3'>\n";
print						"Mushrooms\n";
print					"</label>\n";
print				"</div>\n";
print				"<div class='form-check'>\n";
print					"<input class='form-check-input' type='radio' name='toppingRadios' id='topping4' value='D'>\n";
print					"<label class='form-check-label' for='topping4'>\n";
print						"Pineapple\n";
print					"</label>\n";
print				"</div>\n";
print				"<div class='form-check'>\n";
print					"<input class='form-check-input' type='radio' name='toppingRadios' id='topping5' value='F'>\n";
